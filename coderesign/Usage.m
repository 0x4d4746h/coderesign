...
+ (void)log {
    ...
    printf("\nHOW TO USE:\n     1.Coderesign and decompress icon png:\n     coderesign -d /you/ipa/path/xx.ipa -p your_distribution.mobileprovision -ci certificates_index -py your-python\n     2.Only coderesign:\n     coderesign -d /you/ipa/path/xx.ipa -p your_distribution.mobileprovision -ci certificates_index\n     3.Only decompress icon png:\n     coderesign -d /you/ipa/path/xx.ipa -py your-python\n");
